...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy',       value: 'camera=(), microphone=(), geolocation=()' },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://sandbox.web.squarecdn.com https://web.squarecdn.com https://challenges.cloudflare.com",
      ...
      "media-src 'self'",
      "connect-src 'self' https://*.public.blob.vercel-storage.com https://pci-connect.squareup.com https://pci-connect.squareupsandbox.com https://sandbox.web.squarecdn.com https://web.squarecdn.com https://d1g145x70srn7h.cloudfront.net https://o160250.ingest.sentry.io https://challenges.cloudflare.com",
