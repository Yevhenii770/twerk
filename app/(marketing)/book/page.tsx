...
export const metadata: Metadata = {
  ...
  description: "Reserve your spot in a Twerk or High Heels class at bounce lab in Portland, Oregon. Drop-in $30 or Monthly Pass $100. Easy online booking.",
  ...
  openGraph: {
    ...
    description: "Twerk · High Heels. Drop-in or monthly pass. Portland, Oregon.",
  ...
  twitter: {
    ...
    description: "Twerk · High Heels. Drop-in $30. Book your spot online.",
